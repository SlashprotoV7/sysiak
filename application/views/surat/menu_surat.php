                    ...
                    <div class="el-card-item">
                        <div class="el-card-avatar el-overlay-1"> <img src="<?= base_url(); ?>assets/images/users/1.jpg" alt="user" />
                            <div class="el-overlay">
                                <ul class="el-info">
                                    <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?= base_url(); ?>Surat/surat_tugas"><i class=" icon-action-redo"></i>&nbsp; Create</a></li>
                ...
                <div class="card">
                    <div class="el-card-item">
                        <div class="el-card-avatar el-overlay-1"> <img src="<?= base_url(); ?>assets/images/users/2.jpg" alt="user" />
                            <div class="el-overlay">
                                <ul class="el-info">
                                    <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?= base_url(); ?>Surat/surat_izin1"><font size="1.5px;"><i class="icon-action-redo"></i>&nbsp; Create - Surat Izin Keluar Kantor</font></a></li><br><br>
                                    <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?= base_url(); ?>Surat/surat_izin2"><font size="1.5px;"><i class="icon-action-redo"></i>&nbsp; Create - Surat Izin Tidak Masuk Kerja</font></a></li><br><br>
                                    <li><a class="btn default btn-outline" href="javascript:void(0);"><i class="icon-layers"></i>&nbsp; Lihat Arsip</a></li>
                                </ul>
                            </div>
                        </div>
