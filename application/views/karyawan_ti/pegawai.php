...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Daftar Pegawai</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Data Karyawan/ti</a></li>
                <li class="breadcrumb-item">Data Pegawai</i></li>
                  ...
                  <div class="table-responsive">
                      <?php if ( $usr == true ) { ?>
                        <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list footable-loaded footable" data-page-size="10">
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <th class="footable-sortable">Pangkat/Golongan<span class="footable-sort-indicator"></span></th>
                            ...
                            if ( $usr1['kategori'] == 2 ){
                              ...
                              <tbody>
                                  <tr class="footable-even" style="">
                                      ...
                                      <td>
                                        <a href="<?= base_url(); ?>Karyawan_ti/hapuspegawai1/<?= $usr1['nip']; ?>">
                                        ...
                                        <a href="<?= base_url(); ?>Karyawan_ti/ubahpegawai1/<?= $usr1['nip']; ?>">
                        ...
                        <tfoot>
                            <tr>
                              <td colspan="2">
                                  <a href="<?= base_url(); ?>karyawan_ti/registerpegawai" class="btn btn-info btn-rounded">Tambah Pegawai</a>
                              </td>
                         ...
                         <?php } else { ?>
                           ...
                           <div style="margin-top:20px; text-align:center;"><i class="fa fa-spin fa-refresh" style="font-size: 200px;"></i><br/><br/><font style="font-size:25px; margin-top: 40px;"><b>DATA PEGAWAI TIDAK DITEMUKAN !</b></font><br/><small>Silahkan Diisikan Data Pegawai Terlebih Dahulu</small>
                             <div class="row"  style="width: 100%; margin-top: 25px;">
                               <div class="col-xs-6 col-md-4"></div>
                                  <div class="col-xs-6 col-md-4">
                                    <a href="<?= base_url(); ?>karyawan_ti/registerpegawai"  style="margin-right: 10px; margin-left: 10px;"><button type="button" class="btn btn-md btn-info" style="padding-left:20px ; padding-right: 20px ;">Tambah Data Pegawai</button></a>
