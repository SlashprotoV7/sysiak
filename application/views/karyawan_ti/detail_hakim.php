...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <a href="<?= base_url(); ?>Karyawan_ti/hakim"><button class="btn btn-info"><i class=" fa fa-arrow-circle-left"></i> Kembali</button></a>
        </div>
                        ...
                        <center class="m-t-30"> <img src="<?= base_url();?>assets/images/users/5.jpg" class="img-circle" width="150" />
                            ...
                            <div class="row text-center justify-content-md-center">
                                <div><a href="<?= base_url();?>Konsys/ubah1/<?= $datauser['nip'];?>">
                                  <button class="btn btn-primary"><i class="fa fa-address-card"></i><br/><font style="font-size: 10px;">Ubah Login hakim</font></button></a>
                                </div>
                            </div>
                        </center>
                    </div>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs profile-tab" role="tablist">
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings" role="tab">Detail Data hakim</a> </li>
                    </ul>
                    <!-- Tab panes -->
