            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class=" waves-effect waves-dark" href="<?= base_url(); ?>home" aria-expanded="false"><i class="mdi mdi-home-modern"></i><span class="hide-menu">Beranda</span></a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-card-details"></i><span class="hide-menu">Kepegawaian</span></a>
                            <!--<ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url(); ?>">Daftar Urut Kepangkatan (DUK)</a></li>
                            </ul>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url(); ?>">Kelola Surat</a></li>
                            </ul>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url(); ?>">Data Honorer</a></li>
                            </ul>-->
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-card-details"></i><span class="hide-menu">PTIP</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url(); ?>ptip/report_it">Pelaporan Pemeliharaan Perangkat Elektronik Kantor</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-card-details"></i><span class="hide-menu">Umum & Keuangan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url(); ?>umum_keu/atk">Daftar Permintaan ATK</a></li>
                            </ul>
                        </li>
                        <!--
