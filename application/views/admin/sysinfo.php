...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <a href="<?= base_url(); ?>admin"><button class="btn btn-info"><i class=" fa fa-arrow-circle-left"></i> Kembali</button></a>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Konfigurasi</a></li>
                <li class="breadcrumb-item active">Informasi Sistem</li>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs profile-tab" role="tablist">
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings" role="tab">Detail Informasi System</a> </li>
                    </ul>
                    <!-- Tab panes -->
