                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="pull-right text-right">
                            <address>
                                <h2 class="font-bold" style="margin-right: -3px;"><?= $bulan; ?>&nbsp;&nbsp;</h2>
                                <h6 class="text-muted">Total Form Bulan Ini : <b class="text-danger"><?= $total; ?> Form</b>&nbsp;&nbsp;</h6>
                            </address>
                        </div>
                    </div>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
            <?php if ( $total == true ) { ?> <!-- Jika Data Form nya sudah ada -->
                <!-- Nav tabs -->
                              ...
                              <tbody>
                                  <tr class="footable-even" style="">
                                      ...
                                      <td class="text-center">
                                        <a href="<?= base_url(); ?>Admin/hapusFormMasuk/<?= $forms['id1']; ?>">
                                        ...
                                        <a href="<?= base_url(); ?>Admin/terimaFormMasuk/<?= $forms['id1']; ?>">
                        ...
                        <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list footable-loaded footable" data-page-size="10" style="margin-top: 4px;">
                          ...
                          <tbody>
                              <tr class="footable-even" style="">
                                  ...
                                  <td class="text-center">
                                    <a href="<?= base_url(); ?>Admin/batalFormProses/<?= $formss['id1']; ?>">
                        ...
                        <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list footable-loaded footable" data-page-size="10" style="margin-top: 4px;">
                          ...
                          <tbody>
                              <tr class="footable-even" style="">
                                  ...
                                  <td class="text-center">
                                    <a href="<?= base_url(); ?>Admin/tarikForm/<?= $formsss['id1']; ?>">
                                    ...
                                    <a href="<?= base_url(); ?>Admin/cetakForm/<?= $formsss['id1']; ?>">
                              ...
                              <?php if ( $formx['status_form'] = 14 ){ ?>
                                <tbody>
                                    <tr class="footable-even" style="">
                                        ...
                                        <td class="text-center">
                                          <a href="<?= base_url(); ?>Admin/batalFormTolak/<?= $formx['id1']; ?>">
                                            <button type="button" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="Tarik Kembali Form" onclick="return confirm('Apakah Anda Yakin Untuk Tarik Kembali Form ini?');"><i class="ti-back-left" aria-hidden="true"></i></button>
                                          </a>
                                        </td>
                                    </tr>
...
<div class="modal fade bs-example-modal-lg" id="TolakModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?= base_url('admin/tolakFormMasuk');?>" class="form-horizontal" >
              <div class="card card-body printableArea">
                      <h3 class="form-control" style="margin-top: -13px;">
                        Diajukan Pada :
                      ...
                      <div class="row">
                          ...
                          <input class="form-control id-formsx" name="id-sx" id="id-sx"  type="hidden" readonly>
                          <div class="col-md-12">
                              <div class="form-group row">
...
<div class="modal fade bs-example-modal-lg" id="SelesaiModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?= base_url('admin/terimaFormProses');?>" class="form-horizontal" >
              <div class="card card-body printableArea">
                      <h3 class="form-control" style="margin-top: -13px;">
                        Diproses Pada :
