        ...
        <div class="col-sm-12">
          ...
          <div class="card-header">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal m-t-10" method="post" action="<?= base_url();?>Admin/registerSuratIzin1">

                    <div class="col-md-12">
                      <div class="form-group row">
                          <label class="control-label text-left col-md-3"><small><b>Ketua Pengawas Penegak <br/> Disiplin Pegawai</b></small></label>
                          <div class="col-md-9">
                          <?php foreach( $datapersonil as $si1 ) :?>
                            <?php if ( $si1['jabatan'] == 2 && $si1['status'] == 11 ) :?>
                    ...
                    <div class="col-md-12">
                      <div class="form-group row">
                        <label class="control-label text-left col-md-3"><b>Memberikan Izin Kepada </b></label>
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-md-2">
                              ...
                              <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                  <input type="text" class="form-control"  placeholder="00:00"  id="jam1" name="jam1">
                                  <div class="input-group-append">
                            ...
                            <div class="col-md-2">
                              ...
                              <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                  ...
                                  <input type="text" class="form-control" placeholder="00:00" id="jam2" name="jam2">
                                  <div class="input-group-append">
                                      <span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                                  </div>
                              </div>
