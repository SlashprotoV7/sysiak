                ...
                <div class="card">
                    <div class="card-body">
                      <center class="m-t-30"> <img src="<?= base_url();?>assets/images/users/5.jpg" class="img-circle" width="150" />
                          ...
                          <h6 class="card-subtitle">NIP : <?= $datapersonil['nip'];?></h6>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
              <div class="card">
                  <div class="card-body wizard-content ">
                      ...
                      <form action="<?= base_url();?>Admin/a_ubahpersonilpn1" class="tab-wizard vertical wizard-circle" method="post">
                          <!-- Step 1 -->
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="nip1" id="nip1" value="<?= $datapersonil['nip']; ?>" class="form-control form-control-line" max_length="18">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <select class="form-control custom-select" tabindex="1" name="golongan1" id="golongan1" value="<?= $datapersonil['gol']; ?>">
                                          <option value="#">Pilih Gol</option>
                                          <?php foreach( $golongan as $ju4 ): ?>
                                            <?php if ( $ju4['id'] == $datapersonil['gol'] ){ ?>
                                              <option value="<?= $ju4['id']; ?>" selected><?= $ju4['golongan']; ?></option>
                                            <?php } else {?>
                                              <option value="<?= $ju4['id']; ?>"><?= $ju4['golongan']; ?></option>
                                            <?php } ?>
                                          <?php endforeach;?>
                                      </select>
                                      <?php if ( form_error('golongan1') == true ) :?>
                                      <small class="form-text text-danger"><?= form_error('golongan1'); ?></small>
                                      <?php endif;?>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <input type="date" class="form-control" name="tmt1" id="tmt1" value="<?= $datapersonil['tmt1']; ?>">
                                      <?php if ( form_error('tmt1') == true ) :?>
                                      <small class="form-text text-danger"><?= form_error('tmt1'); ?></small>
                                      <?php endif;?>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="latihan1" id="latihan1" value="<?= $datapersonil['latihan']; ?>">
                                      <?php if ( form_error('latihan1') == true ) :?>
                                      <small class="form-text text-danger"><?= form_error('latihan1'); ?></small>
                                      <?php endif;?>
                                  </div>
                              </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="latihan_tahun1" id="latihan_tahun1" value="<?= $datapersonil['latihan_tahun']; ?>">
                                        <?php if ( form_error('latihan_tahun1') == true ) :?>
                                        <small class="form-text text-danger"><?= form_error('latihan_tahun1'); ?></small>
                                        <?php endif;?>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" name="kgb1" id="kbg1" value="<?= $datapersonil['kgb']; ?>">
                                          <?php if ( form_error('kgb1') == true ) :?>
                                          <small class="form-text text-danger"><?= form_error('kgb1'); ?></small>
                                          <?php endif;?>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" name="kpk1" id="kpk1" value="<?= $datapersonil['kpk']; ?>">
                                          <?php if ( form_error('kpk1') == true ) :?>
                                          <small class="form-text text-danger"><?= form_error('kpk1'); ?></small>
                                          <?php endif;?>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="mutasi1" id="mutasi1" value="<?= $datapersonil['ket']; ?>">
                                          <?php if ( form_error('mutasi1') == true ) :?>
                                          <small class="form-text text-danger"><?= form_error('mutasi1'); ?></small>
                                          <?php endif;?>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" name="mutasi2" id="mutasi2" value="<?= $datapersonil['mutasi']; ?>">
                                          <?php if ( form_error('mutasi2') == true ) :?>
                                          <small class="form-text text-danger"><?= form_error('mutasi2'); ?></small>
                                          <?php endif;?>
                                      </div>
                                  </div>
                              </div>
