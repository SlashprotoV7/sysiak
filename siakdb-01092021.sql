...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2021 at 06:32 AM
...
('197910282003121001', 'Benny Arisandy, SH, MH', 5, '2021-06-29', 2, '2021-06-29', 0, 0, 'Kepemimpinan', '2012', 'Universitas Sriwijaya', '2007', '2', 'Batang Hari', '1979-10-28', '1', '2021-07-17', '2021-07-17', '2021-07-17', 'PN Batam', 'b.arisandy@gmail.com', '081212456953', 'default.jpg', 11, 18, 21),
...
('198005222003121001', 'Medi Rapi Batara Randa, SH, MH', 5, '2018-04-01', 1, '2021-01-27', 0, 0, 'Pel.Yudisial Berkelanjutan', '2008', 'Sekolah Tinggi Ilmu Hukum IBLAM', '2018', '2', 'Toraja', '1980-05-22', '1', '2021-12-01', '2022-04-01', '2021-01-27', 'PN Majene', 'medirapi@mahkamahagung.go.id', '081381013496', 'default.jpg', 11, 18, 21),
('198104212009041003', 'Muhammad Ronaldi, ST', 7, '2017-04-01', 5, '2015-12-29', 0, 0, 'Diklat Kepemimpinan Tk.IV', '2019', 'Universitas Sultan Syarif Kasim', '2005', '3', 'Pekanbaru', '1981-04-21', '1', '2021-04-01', '2021-04-01', '2021-12-29', 'PN Pelalawan', 'ronaldi@gmail.com', '085264994775', 'default.jpg', 11, 18, 22),
('198308222014082002', 'Susi Wulandari, SH', 12, '2018-10-01', 24, '2020-06-12', 0, 0, 'Pra Jabatan', '2015', 'Universitas Terbuka', '2020', '3', 'Tg.Balai Karimun', '1983-08-22', '2', '2021-08-01', '2022-10-01', '0001-01-01', '-', 'susi@gmail.com', '081275891789', 'default.jpg', 11, 18, 22),
...
('199303272017121004', 'Alfonsius Joko Martin Pampang Siringoringo, SH', 9, '2017-12-01', 3, '2020-04-23', 0, 0, 'Diklat Calon Hakim Terpadu', '2019', 'Universitas Padjajaran', '2015', '3', 'Medan', '1993-03-27', '1', '2021-12-01', '2021-12-01', '0001-01-01', '-', 'alfonsiusjps@gmail.com', '081322686446', 'default.jpg', 11, 18, 21),
...
('199306242020121001', 'Reiva Adnan Sulaiman, A.Md, A.B', 11, '2020-12-01', 25, '2021-01-28', 0, 0, '-', '-', 'Politeknik Negeri Bandung', '2019', '4', 'Bandung', '1993-06-24', '1', '2021-12-01', '2024-12-01', '0001-01-01', '-', 'reiva.adnans@mahkamahagung.go.id', '087821661993', 'default.jpg', 11, 19, 23),
...
('202101', 'Hera Indra, S.Si', 18, '0000-00-00', 19, '2021-07-22', 0, 0, '-', '', 'Univesitas Islam Riau', '2009', '4', 'Karimun', '1986-04-02', '2', '0000-00-00', '0000-00-00', '0000-00-00', '-', 'hera@yahoo.co.id', '0822555476444', 'default.jpg', 11, 18, 24),
('202102', 'Arex Riau Protomo, A.Md', 18, '0000-00-00', 20, '2021-07-22', 0, 0, '-', '', 'Politeknik Negeri Batam', '2017', '4', 'Batu Lipai', '1996-04-16', '1', '0000-00-00', '0000-00-00', '0000-00-00', '-', 'arexprotomo2@gmail.com', '081266345574', 'default.jpg', 11, 19, 24),
('202103', 'Shodikul Waadil Amin, SH', 18, '0000-00-00', 15, '2021-07-22', 0, 0, '-', '', 'Universitas Karimun', '2020', '3', 'Jepara', '1991-10-28', '1', '0000-00-00', '0000-00-00', '0000-00-00', '-', 'dikul@gmail.com', '085271996447', 'default.jpg', 11, 18, 24),
('202104', 'Ruth Hellen Simantupang, A.Md', 18, '0000-00-00', 15, '2021-07-21', 0, 0, '-', '', 'STIK Tarakanita', '2009', '4', 'Tg.Balai karimun', '1989-06-17', '2', '0000-00-00', '0000-00-00', '0000-00-00', '-', 'helen@gmail.com', '082111057773', 'default.jpg', 11, 18, 24),
('202105', 'Ikhwandi Putra Rambe', 18, '0000-00-00', 16, '2021-07-21', 0, 0, '', '', '-', '2005', '5', 'Tg.Balai karimun', '1988-07-07', '1', '0000-00-00', '0000-00-00', '0000-00-00', '', 'putra@gmail.com', '085264604449', 'default.jpg', 11, 18, 24),
('202106', 'Sentia Gusrini', 18, '0000-00-00', 16, '2021-07-22', 0, 0, '', '', '-', '2015', '5', 'Meral Karimun', '1997-08-23', '2', '0000-00-00', '0000-00-00', '0000-00-00', '', 'sentia@gmail.com', '081365471199', 'default.jpg', 11, 18, 24),
('202107', 'Mimi Susanti, SH', 18, '0000-00-00', 17, '2021-07-22', 0, 0, '', '', 'Universitas Karimun', '2020', '3', 'Inderapura', '1983-08-13', '2', '0000-00-00', '0000-00-00', '0000-00-00', '', 'mimi@gmail.com', '081364643820', 'default.jpg', 11, 18, 24),
...
CREATE TABLE `b_surat` (
  ...
  `timbang_dasarhukum` varchar(256) NOT NULL,
  `id_A` varchar(20) NOT NULL,
  `id_B` varchar(20) DEFAULT NULL,
  `id_C` varchar(20) DEFAULT NULL,
  `id_D` varchar(20) DEFAULT NULL,
  `id_E` varchar(20) DEFAULT NULL,
  `id_F` varchar(20) DEFAULT NULL,
  `id_G` varchar(20) DEFAULT NULL,
  `id_H` varchar(20) DEFAULT NULL,
  `id_I` varchar(20) DEFAULT NULL,
  `id_J` varchar(20) DEFAULT NULL,
  `uraian` text NOT NULL,
  `tgl_surat` varchar(10) NOT NULL,
  `jam1` varchar(5) NOT NULL,
  `jam2` varchar(5) NOT NULL,
  `tgl_surat2` int(10) NOT NULL,
  `kode_dipa` int(11) DEFAULT NULL COMMENT '663005 = DIPA 01 | 663006 = Dipa 03',
  `created_id` int(11) NOT NULL COMMENT 'dibuat oleh',
  `time_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Waktu Dibuatkan Suratnya'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `b_surat`
--

INSERT INTO `b_surat` (`id`, `jenis_surat`, `kode1`, `no_surat`, `kode2`, `bln`, `tahun`, `id_acc`, `timbang_dasarhukum`, `id_A`, `id_B`, `id_C`, `id_D`, `id_E`, `id_F`, `id_G`, `id_H`, `id_I`, `id_J`, `uraian`, `tgl_surat`, `jam1`, `jam2`, `tgl_surat2`, `kode_dipa`, `created_id`, `time_created`) VALUES
(6, 1, 'W4.U9', 1, 'KP.01.2', '08', '2021', '198005222003121001', '<p><span xss=removed><span xss=removed>Menimbang        :              a. Bnknfnfhbvhfvbfhbvfvbsjjld</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 Basdbshagdhsadbshdgscsyvcysvc</span></span></p', '197910282003121001', '198710112017121001', '', '', '', '', '', '', '', '', '<p><span xss=removed><span xss=removed>Menimbang        :              a. Bnknfnfhbvhfvbfhbvfvbsjjld</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 Basdbshagdhsadbshdgscsyvcysvc</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                             b. djsdjhsaudusdhushd</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 dafdsfsd</span></span></p>', '2021-08-31', '', '', 0, 663005, 0, '0000-00-00 00:00:00'),
(7, 1, 'W4.U9', 2, 'KP.01.2', '08', '2021', '198005222003121001', '<p><span xss=removed><span xss=removed>Menimbang        :              a. Bnknfnfhbvhfvbfhbvfvbsjjld</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 Basdbshagdhsadbshdgscsyvcysvc</span></span></p', '198409022009041004', '197206291993031001', '196511281993031003', '196908171993031007', '202106', '202104', '202107', '', '', '', '<p><span xss=removed><span xss=removed>Menimbang        :              a. Bnknfnfhbvhfvbfhbvfvbsjjld</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 Basdbshagdhsadbshdgscsyvcysvc</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                             b. djsdjhsaudusdhushd</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 dafdsfsd</span></span></p>', '2021-08-31', '', '', 0, 663006, 0, '0000-00-00 00:00:00'),
(8, 2, '-', 0, '-', '08', '2021', '197910282003121001', '-', '198710112017121001', '', '', '', '', '', '', '', '', '', '<p>Jemput Istri</p>', '2021-08-31', '14:00', '15:00', 0, 0, 0, '0000-00-00 00:00:00'),
(9, 2, '-', 0, '-', '08', '2021', '197910282003121001', '-', '198104212009041003', '', '', '', '', '', '', '', '', '', '<p>Jemput anak sekolah & ambil rapot kenaikan kelas anak</p>', '2021-08-31', '10:00', '12:00', 0, 0, 0, '0000-00-00 00:00:00'),
(10, 1, 'W4.U9', 3, 'KP.01.2', '08', '2021', '198005222003121001', '<p><span xss=removed><span xss=removed>Menimbang        :              a. Bnknfnfhbvhfvbfhbvfvbsjjld</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 Basdbshagdhsadbshdgscsyvcysvc</span></span></p', '198506062009042007', '', '', '', '', '', '', '', '', '', '<p><span xss=removed><span xss=removed>Menimbang        :              a. Bnknfnfhbvhfvbfhbvfvbsjjld</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 Basdbshagdhsadbshdgscsyvcysvc</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                             b. djsdjhsaudusdhushd</span></span></p>\r\n\r\n<p><span xss=removed><span xss=removed>                                                 dafdsfsd</span></span></p>', '2021-08-31', '', '', 0, 663005, 0, '0000-00-00 00:00:00'),
(11, 3, '-', 0, '-', '08', '2021', '198005222003121001', '-', '199208022017121005', '', '', '', '', '', '', '', '', '', '<p>Mau Vaksinasi Ke-3</p>', '2021-08-31', '', '', 0, 0, 0, '0000-00-00 00:00:00'),
(12, 3, '-', 0, '-', '09', '2021', '198005222003121001', '-', '198308222014082002', '', '', '', '', '', '', '', '', '', '<p>Mau Vaksinasi Ke-2</p>', '2021-09-01', '', '', 0, 0, 0, '0000-00-00 00:00:00'),
(13, 1, 'W4.U9', 4, 'KP.01.2', '09', '2021', '198005222003121001', '<p>Ddaefefeffe</p>', '199306242020121001', '', '', '', '', '', '', '', '', '', '<p>adasdasda</p>', '2021-09-01', '', '', 0, 663006, 0, '0000-00-00 00:00:00'),
(14, 1, 'W4.U9', 5, 'KP.01.2', '09', '2021', '198005222003121001', '<p>cacasascas</p>', '198512192009042006', '', '', '', '', '', '', '', '', '', '<p>cacascas</p>', '2021-09-01', '', '', 0, 663006, 0, '0000-00-00 00:00:00'),
(15, 1, 'W4.U9', 6, 'KP.01.2', '09', '2021', '198005222003121001', '<p>asdasdas</p>', '202107', '', '', '', '', '', '', '', '', '', '<p>asdasdsdada</p>', '2021-09-01', '', '', 0, 663006, 0, '0000-00-00 00:00:00'),
(16, 1, 'W4.U9', 7, 'KP.01.2', '09', '2021', '198005222003121001', '<p>dsadsadsadsd</p>', '197910282003121001', '', '', '', '', '', '', '', '', '', '<p>adasdsad</p>', '2021-09-01', '', '', 0, 663005, 0, '0000-00-00 00:00:00'),
(17, 1, 'W4.U9', 8, 'KP.01.2', '09', '2021', '198005222003121001', '<p>cdfvgbgbnnh</p>', '202104', '', '', '', '', '', '', '', '', '', '<p>dasdad</p>', '2021-09-01', '', '', 0, 663006, 0, '0000-00-00 00:00:00'),
(18, 1, 'W4.U9', 9, 'KP.01.2', '09', '2021', '198005222003121001', '<p>dsadasdasdssdadadad</p>', '199210102017121010', '', '', '', '', '', '', '', '', '', '<p>loikuj</p>', '2021-09-01', '', '', 0, 663006, 0, '0000-00-00 00:00:00'),
(19, 1, 'W4.U9', 10, 'KP.01.2', '09', '2021', '198005222003121001', '<p>21312323</p>', '197206291993031001', '', '', '', '', '', '', '', '', '', '<p>312313</p>', '2021-09-01', '', '', 0, 663005, 0, '0000-00-00 00:00:00');
...
(7, 1, '198104212009041003', 5, 3, '2021-09-01', 9, 1, 'yy', 7, '-', '2021-09-01', 'ok', '2021-09-01', '-', '0000-00-00', '', '');
...
(663005, '01', 'Badan Urusan Administrasi (BUA)'),
(663006, '03', 'Badan Peradilan Umum (Badilum)');
...
--
-- Table structure for table `ref_surat1`
--

CREATE TABLE `ref_surat1` (
  `id_bagian` int(11) NOT NULL COMMENT 'Foreign Key dari "ref_bagian" yaitu id',
  `kode1` varchar(5) NOT NULL,
  `kode2` varchar(7) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ref_surat1`
--

INSERT INTO `ref_surat1` (`id_bagian`, `kode1`, `kode2`) VALUES
(8, 'W4.U9', 'KP.01.2');
...
--
-- AUTO_INCREMENT for table `b_surat`
--
ALTER TABLE `b_surat`
